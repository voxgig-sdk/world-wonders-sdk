...
#      offline in seeded test mode (WorldWondersSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "WorldWonders_sdk.rb")
  SDK_CLASS = "WorldWondersSDK"
