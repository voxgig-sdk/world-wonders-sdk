...
type WonderEntity struct {
	name    string
	client  *core.WorldWondersSDK
...
func NewWonderEntity(client *core.WorldWondersSDK, entopts map[string]any) *WonderEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *WonderEntity) GetName() string { return e.name }
...
func (e *WonderEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *WonderEntity) Deleted() bool {
	return e.deleted
}


func (e *WonderEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewWonderEntity(e.client, opts)
}

func (e *WonderEntity) Data(args ...any) any {
...
func (e *WonderEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Wonder; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *WonderEntity) DataTyped(data ...Wonder) Wonder {
	if len(data) > 0 {
		return typedFrom[Wonder](e.Data(asMap(data[0])))
	}
	return typedFrom[Wonder](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Wonder (all fields
// optional at the wire level).
func (e *WonderEntity) MatchTyped(match ...Wonder) Wonder {
	if len(match) > 0 {
		return typedFrom[Wonder](e.Match(asMap(match[0])))
	}
	return typedFrom[Wonder](e.Match())
}
...
func (e *WonderEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *WonderEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// WonderLoadMatch and returns an Wonder. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *WonderEntity) LoadTyped(reqmatch WonderLoadMatch, ctrl map[string]any) (Wonder, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Wonder{}, err
	}
	return typedFrom[Wonder](res), nil
}




func (e *WonderEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// WonderListMatch and returns []Wonder. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *WonderEntity) ListTyped(reqmatch WonderListMatch, ctrl map[string]any) ([]Wonder, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Wonder](res), nil
}



func (e *WonderEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *WonderEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *WonderEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *WonderEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
