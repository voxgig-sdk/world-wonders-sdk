...
// instead of `sdk.NewWorldWondersSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *WorldWondersSDK  { return NewWorldWondersSDK(nil) }
func Test() *WorldWondersSDK { return TestSDK(nil, nil) }
