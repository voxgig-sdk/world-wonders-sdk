...
func (sdk *WorldWondersSDK) OptionsMap() map[string]any {
...
func (sdk *WorldWondersSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *WorldWondersSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *WorldWondersSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *WorldWondersSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *WorldWondersSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *WorldWondersSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("WorldWondersSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *WorldWondersSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *WorldWondersSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("WorldWondersSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *WorldWondersSDK {
	...
	sdk := NewWorldWondersSDK(sdkopts)
	sdk.Mode = "test"
