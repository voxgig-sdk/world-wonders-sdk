// Command WorldWonders-cli is a CLI + REPL for the WorldWonders SDK,
...
const prompt = "world-wonders"

// entitiesHelp is the space-separated entity list shown by /help.
const entitiesHelp = "wonder"
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      WORLD_WONDERS_APIKEY (api key), WORLD_WONDERS_BASE (base url override)")
...
func run(args []string, in io.Reader, out, errOut io.Writer) int {
	...
	// Configure from the environment: WORLD_WONDERS_APIKEY carries the API key and
	// WORLD_WONDERS_BASE optionally overrides the API base URL (e.g. production).
	// Both injectable by a secrets vault. Unset -> nil config defaults.
	var opts map[string]any
	if apikey := os.Getenv("WORLD_WONDERS_APIKEY"); apikey != "" {
		opts = map[string]any{"apikey": apikey}
	}
	if base := os.Getenv("WORLD_WONDERS_BASE"); base != "" {
		if opts == nil {
			opts = map[string]any{}
		}
		opts["base"] = base
	}
	client := sdk.NewWorldWondersSDK(opts)
