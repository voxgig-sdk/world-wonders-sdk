...
func registerSDKWords(r *eng.Registry, client *sdk.WorldWondersSDK) {
...
func runOp(client *sdk.WorldWondersSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
