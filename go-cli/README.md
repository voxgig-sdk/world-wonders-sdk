...
AQL-driven CLI and REPL for the WorldWonders SDK. Positional arguments are
...
./world-wonders-cli load 1 wonder
./world-wonders-cli load '{id:1}' wonder
