...
type Args struct {
	Entity string         `json:"entity" jsonschema:"wonder"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.WorldWondersSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "world-wonders_list",
		Description: "List records from WorldWonders. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "world-wonders_load",
		Description: "Load a single record from WorldWonders. " +
...
func runOp(client *sdk.WorldWondersSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.WorldWondersSDK, name string) (sdk.WorldWondersEntity, error) {
	switch strings.ToLower(name) {
	case "wonder":
		return client.Wonder(nil), nil
