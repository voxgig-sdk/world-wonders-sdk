// Command WorldWonders-mcp is an MCP server exposing the WorldWonders
// SDK as MCP tools.
//
// Two tools are registered:
//
//	WorldWonders_list  — list records of an entity
//	WorldWonders_load  — load a single record of an entity
//
