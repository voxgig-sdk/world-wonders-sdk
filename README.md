...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/world-wonders` | `npm install @voxgig-sdk/world-wonders` |
| Python | `voxgig-sdk-world-wonders` | `pip install voxgig-sdk-world-wonders` |
| PHP | `voxgig-sdk/world-wonders` | `composer require voxgig-sdk/world-wonders` |
| Golang | `github.com/voxgig-sdk/world-wonders-sdk/go` | `go get github.com/voxgig-sdk/world-wonders-sdk/go` |
| Ruby | `voxgig-sdk-world-wonders` | `gem install voxgig-sdk-world-wonders` |
| Lua | `voxgig-sdk-world-wonders` | `luarocks install voxgig-sdk-world-wonders` |
