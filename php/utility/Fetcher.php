...
// WorldWonders SDK utility: fetcher

class WorldWondersFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; WorldWondersSDK/1.0)';
    ...
    public static function call(WorldWondersContext $ctx, string $fullurl, array $fetchdef): array
    {
