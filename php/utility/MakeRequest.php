...
// WorldWonders SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class WorldWondersMakeRequest
{
    public static function call(WorldWondersContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new WorldWondersResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new WorldWondersResponse($fetched);
        } else {
