...
// WorldWonders SDK utility: graphql
//
...
class WorldWondersGraphql
{
    ...
    // equivalent.
    public static function body(WorldWondersContext $ctx): mixed
    {
    ...
    public static function errors(WorldWondersContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
