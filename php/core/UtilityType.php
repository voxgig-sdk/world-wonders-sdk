...
// WorldWonders SDK utility type

class WorldWondersUtility
{
    ...
    public static function copy(WorldWondersUtility $src): WorldWondersUtility
    {
        $u = new WorldWondersUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
