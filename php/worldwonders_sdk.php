...
class WorldWondersSDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = WorldWondersHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = WorldWondersHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ...
                        if (!WorldWondersFeatures::has_feature($fname)) {
                        ...
                        ($utility->feature_add)($this->_rootctx, WorldWondersFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return WorldWondersUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = WorldWondersHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = WorldWondersHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = WorldWondersHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    private function op_denied(string $op): array
    {
        ...
        return [
            "ok" => false,
            "err" => new WorldWondersError($op . "_allow",
                "WorldWondersSDK: " . $op . ": operation not allowed by" .
    ...
    private function raw_request(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = WorldWondersHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function graphql(string $query, ?array $variables = null, ?array $ctrl = null): mixed
    {
        ...
        if (is_array($errors) && 0 < count($errors)) {
            ...
            $res["ok"] = false;
            $res["err"] = new WorldWondersError("graphql_error",
                "WorldWondersSDK: graphql: " . $msg);
            $res["graphql"] = $errors;
        }
    ...
    public function Wonder($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_wonder === null) {
                $this->_wonder = new WonderEntity($this, null);
            }
            return $this->_wonder;
        }
        return new WonderEntity($this, $data);
    }
    ...
    public static function test(?array $testopts = null, ?array $sdkopts = null): self
    {
        ...
        $sdk = new WorldWondersSDK($sdkopts);
        $sdk->mode = "test";
        return $sdk;
    }
}
