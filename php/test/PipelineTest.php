...
// WorldWonders SDK pipeline test
//
...
{
    private static function utility(): WorldWondersUtility
    {
        return new WorldWondersUtility();
    }
    ...
    private static function ctx(array $over = []): WorldWondersContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new WorldWondersContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new WorldWondersOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof WorldWondersError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new WorldWondersOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = WorldWondersMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new WorldWondersOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = WorldWondersMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new WorldWondersOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = WorldWondersMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new WorldWondersSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = WorldWondersMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new WorldWondersResponse([]),
            'result' => new WorldWondersResult([]),
        ]);
        [, $err] = WorldWondersMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new WorldWondersSpec([]),
            'response' => null,
            'result' => new WorldWondersResult([]),
        ]);
        [, $err] = WorldWondersMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new WorldWondersSpec(['step' => 's']),
            'response' => new WorldWondersResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new WorldWondersResult([]),
        ]);
        [, $err] = WorldWondersMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new WorldWondersSpec(['step' => 's']),
            'response' => new WorldWondersResponse(self::resp(200, ['v' => 1])),
            'result' => new WorldWondersResult([]),
        ]);
        [, $err] = WorldWondersMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new WorldWondersSpec(['step' => 's']),
            'response' => new WorldWondersResponse(self::resp(200, ['v' => 2])),
            'result' => new WorldWondersResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        WorldWondersMakeResponse::call($ctx);
    ...
    {
        $preset = new WorldWondersResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new WorldWondersSpec([]),
            'response' => new WorldWondersResponse([]),
            'result' => new WorldWondersResult([]),
        ...
        [$got, $err] = WorldWondersMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new WorldWondersResult([])]);
        [, $err] = WorldWondersMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new WorldWondersSpec([]), 'result' => null]);
        [, $err] = WorldWondersMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new WorldWondersSpec(['step' => 's']),
            'result' => new WorldWondersResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new WorldWondersOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = WorldWondersMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new WorldWondersSpec(['step' => 's']),
            'result' => new WorldWondersResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new WorldWondersOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = WorldWondersMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new WorldWondersResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new WorldWondersSpec([]),
            'result' => new WorldWondersResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = WorldWondersMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = WorldWondersMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new WorldWondersError('boom', 'boom');
        $utility->fetcher = function (WorldWondersContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new WorldWondersSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = WorldWondersMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (WorldWondersContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = WorldWondersMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(WorldWondersResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        WorldWondersMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (WorldWondersContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new WorldWondersSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = WorldWondersMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new WorldWondersResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new WorldWondersSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = WorldWondersMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = WorldWondersMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = WorldWondersMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new WorldWondersResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, WorldWondersDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new WorldWondersResult(['ok' => false])]);
        $this->expectException(WorldWondersError::class);
        WorldWondersDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new WorldWondersResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', WorldWondersMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        WorldWondersMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new WorldWondersBaseFeature();
        $b = new WorldWondersBaseFeature();
        WorldWondersFeatureAdd::call($ctx, $a);
        WorldWondersFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): WorldWondersBaseFeature
    {
        $f = new WorldWondersBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        WorldWondersFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): WorldWondersContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new WorldWondersSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = WorldWondersPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        WorldWondersPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new WorldWondersResponse(['headers' => null]),
            'result' => new WorldWondersResult([]),
        ]);
        WorldWondersResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        WorldWondersResultBody::call($ctx);
