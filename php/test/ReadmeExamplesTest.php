...
// WorldWonders SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (WorldWondersSDK::test)
...
{
    private const SDK_CLASS = 'WorldWondersSDK';
    ...
    private const SDK_BASE = 'worldwonders_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../worldwonders_sdk.php';
