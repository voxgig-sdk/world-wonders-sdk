...
// WorldWonders SDK metrics feature
...
class WorldWondersMetricsFeature extends WorldWondersBaseFeature
{
    ...
    private function _record(WorldWondersContext $ctx, bool $ok): void
    {
