...
// WorldWonders SDK audit feature
...
class WorldWondersAuditFeature extends WorldWondersBaseFeature
{
    ...
    private function _emit(WorldWondersContext $ctx, string $outcome): void
    {
