...
// WorldWonders SDK netsim feature
...
class WorldWondersNetsimFeature extends WorldWondersBaseFeature
{
    ...
    private function _simulate(WorldWondersContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(WorldWondersContext $ctx, array $applied): void
    {
        $client = $this->client;
