...
// WorldWonders SDK debug feature
...
class WorldWondersDebugFeature extends WorldWondersBaseFeature
{
    ...
    private function _finish(WorldWondersContext $ctx, bool $ok): void
    {
