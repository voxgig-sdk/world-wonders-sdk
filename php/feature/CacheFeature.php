...
// WorldWonders SDK cache feature
...
class WorldWondersCacheFeature extends WorldWondersBaseFeature
{
    ...
    private function _through(WorldWondersContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
