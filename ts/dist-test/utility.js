...
function envOverride(m) {
    if ('TRUE' === process.env.WORLD_WONDERS_TEST_LIVE ||
        'TRUE' === process.env.WORLD_WONDERS_TEST_OVERRIDE) {
    ...
    m.WORLD_WONDERS_TEST_EXPLAIN = process.env.WORLD_WONDERS_TEST_EXPLAIN || m.WORLD_WONDERS_TEST_EXPLAIN;
    return m;
}
