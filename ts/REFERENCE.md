# WorldWonders TypeScript SDK Reference

Complete API reference for the WorldWonders TypeScript SDK.
...
```ts
new WorldWondersSDK(options?: object)
```
...
#### `WorldWondersSDK.test(testopts?, sdkopts?)`
...
**Returns:** `WorldWondersSDK` instance in test mode.
...
Create a new `Wonder` entity instance.
...
Alias for `WorldWondersSDK.test()`.
...
Return the parent `WorldWondersSDK` instance.
