...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.WORLDWONDERS_TEST_LIVE ||
    'TRUE' === process.env.WORLDWONDERS_TEST_OVERRIDE
  ) {
  ...
  m.WORLDWONDERS_TEST_EXPLAIN = process.env.WORLDWONDERS_TEST_EXPLAIN || m.WORLDWONDERS_TEST_EXPLAIN
