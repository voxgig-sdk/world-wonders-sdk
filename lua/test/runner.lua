...
function runner.env_override(m)
  local live = runner.getenv("WORLDWONDERS_TEST_LIVE")
  local override = runner.getenv("WORLDWONDERS_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("WORLDWONDERS_TEST_EXPLAIN")
