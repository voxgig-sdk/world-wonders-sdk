...
|---|---|---|
| `ts/` | @voxgig-sdk/world-wonders-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/world-wonders-sdk \
      --repository voxgig-sdk/world-wonders-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/world-wonders-sdk` shows it, and
`npm trust revoke @voxgig-sdk/world-wonders-sdk --id=<id>` removes it.
