...
// WorldWonders SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = WorldWondersOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(WorldWondersOmni::structfix($now, Struct::undef()))
                        !== json_encode(WorldWondersOmni::structfix($val, Struct::undef()))) {
