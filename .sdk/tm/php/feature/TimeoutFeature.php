...
// WorldWonders SDK timeout feature
...
class WorldWondersTimeoutFeature extends WorldWondersBaseFeature
{
    ...
    private function _with_timeout(WorldWondersContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(WorldWondersContext $_ctx, float $ms): void
    {
        $client = $this->client;
