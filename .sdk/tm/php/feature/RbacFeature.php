...
class WorldWondersRbacFeature extends WorldWondersBaseFeature
{
    ...
    private function _required(WorldWondersContext $ctx): ?string
    {
    ...
    private function _reject(WorldWondersContext $ctx, string $required): void
    {
    ...
    private function _track(WorldWondersContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
