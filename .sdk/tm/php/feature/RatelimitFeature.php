...
// WorldWonders SDK ratelimit feature
...
class WorldWondersRatelimitFeature extends WorldWondersBaseFeature
{
    ...
    private function _acquire(WorldWondersContext $ctx): void
    {
    ...
    private function _track(WorldWondersContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
