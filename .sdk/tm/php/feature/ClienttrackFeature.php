...
// WorldWonders SDK clienttrack feature
...
class WorldWondersClienttrackFeature extends WorldWondersBaseFeature
{
    ...
    public function PostConstruct(WorldWondersContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'WorldWonders-SDK';
