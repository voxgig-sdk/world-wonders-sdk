...
// WorldWonders SDK proxy feature
...
class WorldWondersProxyFeature extends WorldWondersBaseFeature
{
    ...
    public function init(WorldWondersContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (WorldWondersContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
