...
// WorldWonders SDK streaming feature
...
class WorldWondersStreamingFeature extends WorldWondersBaseFeature
{
    ...
    private function _iterate(WorldWondersResult $result): \Generator
    {
    ...
    private function _streamable(WorldWondersContext $ctx): bool
    {
