...
// WorldWonders SDK utility: make_options

class WorldWondersMakeOptions
{
    ...
    public static function call(WorldWondersContext $ctx): array
    {
        ...
        //
        // `WorldWondersSchema::optspec()` is built from the model:
        ...
        $optspec = WorldWondersSchema::optspec();
