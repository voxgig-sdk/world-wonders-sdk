...
from projectname_sdk.core.control import WorldWondersControl
...
class WorldWondersContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, WorldWondersSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, WorldWondersResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, WorldWondersResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return WorldWondersError(code, msg, self)
