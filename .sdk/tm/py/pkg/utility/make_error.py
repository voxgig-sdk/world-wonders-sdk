# WorldWonders SDK utility: make_error
...
def make_error_util(ctx, err):
    ...
    errmsg = ""
    if isinstance(err, WorldWondersError):
        errmsg = err.msg
    ...
    msg = "WorldWondersSDK: " + opname + ": " + errmsg
    ...
    sdk_err = WorldWondersError("", msg, ctx)
