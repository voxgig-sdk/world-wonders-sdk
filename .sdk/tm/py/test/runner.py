...
class WorldWondersTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = WorldWondersTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = WorldWondersTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = WorldWondersTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
