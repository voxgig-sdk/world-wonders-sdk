...
class WorldWondersTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = WorldWondersTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = WorldWondersTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = WorldWondersTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
