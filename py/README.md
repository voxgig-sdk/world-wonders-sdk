# WorldWonders Python SDK



The Python SDK for the WorldWonders API — an entity-oriented client following Pythonic conventions.

The SDK exposes the API as capitalised, semantic **Entities** — for example `client.Wonder()` — each
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/world-wonders-sdk/releases)) or
...
```
py/
├── worldwonders_sdk.py         -- Main SDK module
