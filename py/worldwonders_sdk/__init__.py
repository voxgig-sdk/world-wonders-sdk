...
from worldwonders_sdk.utility import register

# Load features
from worldwonders_sdk.feature.base_feature import WorldWondersBaseFeature
from worldwonders_sdk.features import _has_feature, _make_feature
...
class WorldWondersSDK:
    ...
    def get_utility(self):
        return WorldWondersUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("WorldWondersSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Wonder(self, data=None) -> "WonderEntity":
        ...
        from worldwonders_sdk.entity.wonder_entity import WonderEntity
