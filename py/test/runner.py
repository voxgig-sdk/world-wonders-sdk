...
class WorldWondersTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = WorldWondersTestRunner.getenv("WORLDWONDERS_TEST_LIVE")
        override = WorldWondersTestRunner.getenv("WORLDWONDERS_TEST_OVERRIDE")
        ...
        explain = WorldWondersTestRunner.getenv("WORLDWONDERS_TEST_EXPLAIN")
