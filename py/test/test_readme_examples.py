# WorldWonders SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions WorldWondersSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both WorldWondersSDK(...) and WorldWondersSDK.test(...) become
#      WorldWondersSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "worldwonders_sdk"
_SDK_CLASS = "WorldWondersSDK"
